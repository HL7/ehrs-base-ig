A HL7 EHR System Functional Model provides a reference list of functions that may be present in an Electronic
...
A HL7 EHR-S Functional Model defines a standardized model of the functions that may be present in EHR
...
of a Functional Model, the term “system” is used generically to cover the continuum of implementation options.
...
A EHR-S Functional Model package includes both Informative and Normative sections.
